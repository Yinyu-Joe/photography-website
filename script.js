...
const copy = {
  zh: {
    ...
    "home.intro": "朱垠宇的旅行、城市与日常摄影。这里收录我在不同地域移动、停留与观看时留下的片段。",
    "home.viewAll": "查看全部作品",
    "home.galleryLabel": "精选摄影作品",
    "home.contactLink": "聊聊你的想法",
    "nav.work": "作品",
    "nav.places": "地图",
    "nav.story": "故事",
    "nav.about": "关于",
  ...
  en: {
    ...
    "home.intro": "Travel, city, and everyday photography by Yinyu Zhu, gathered from moments of movement, pause, and observation across different places.",
    "home.viewAll": "View all work",
    "home.galleryLabel": "Selected photography",
    "home.contactLink": "Start a conversation",
    "nav.work": "Works",
    "nav.places": "Map",
    "nav.story": "Story",
    "nav.about": "About",
